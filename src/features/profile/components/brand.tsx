...
import { TarunpreetSinghWordmark } from "@/components/tarunpreet-singh-wordmark";
      ...
      <BrandContextMenu>
        <div className="grid grid-cols-[2rem_1fr]">
          ...
          <div className="screen-line-after flex items-center justify-center pr-8 after:z-1">
            <TarunpreetSinghMark className="h-8 w-auto sm:h-12" />
          </div>
          ...
          <div className="screen-line-after flex items-center justify-center pr-8 after:z-1">
            <TarunpreetSinghWordmark className="h-6 w-auto sm:h-10" />
          </div>
        </div>
      </BrandContextMenu>
    </Panel>
